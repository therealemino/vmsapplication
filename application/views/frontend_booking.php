...
<body>
    ...
    <div class="tb_header">
        <div class="container">
            <div class="col-md-6" style="padding:0;">
                <div style="margin-top: 20px;"> <img heigth="100" width="100"
                        src="<?= base_url() ?>assets/uploads/landinglogo.PNG"> </div>
            </div>
            ...
            <div class="col-md-2" style="width:30%; float:right;">
                ...
                <div class="signin_up">
                    <ul>
                        ...
                        <li><a href="<?php echo base_url(); ?>frontendbooking/mybookings">My Bookings</a> <span
    ...
    <div class="modal fade" id="myModals" role="dialog" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog">
            ...
            <form id="login" method="post" class="basicvalidation"
                action="<?php echo base_url(); ?>/frontendbooking/login">
                <div class="login-block">
                    <h1>Login</h1>
                    <input type="text" required name="username" placeholder="Email" class="username" id="username"
                        required="" />
                    <input type="password" required class="password" name="password" placeholder="Password"
                    ...
                    <div class="sign_in"><a data-dismiss="modal" href="#myModal" data-toggle="modal"
                            data-target="#myModal">Sign Up</a></div>
                </div>
            </form>
        </div>
    </div>
            ...
            <form id="forgot" data-parsley-validate="">
                <div class="login-block">
                    ...
                    <!--    <span class="terms_tb">By signing up, you agree to our <a class="cond_tb" href="#">Terms and Conditions.</a></span> <br>
                     <br> -->
                    <button class='btn' type="reset" name="RESET" style="position: relative;"
                        onclick="Forgot()">RESET</button>
                    <br>
    ...
    <div class="container">
        ...
        <div class="row" style="min-height:400px;margin-top:120px;">
            ...
            <div class="col-md-6">
                <form id="booking" method="POST" class="basicvalidation"
                    action="<?php echo base_url(); ?>frontendbooking/book">
                    <section id="Search" class="LB XXCN  P20">
                        ...
                        <div class="searchRow clearfix">
                            <div class="LB">
                                ...
                                <input id="t_trip_fromlocation" name="t_trip_fromlocation" class="XXinput searching"
                                    placeholder="Enter From" type="text" tabindex="1" required />
                            </div>
                            <span class="switchButton" id="switchButton"></span>
                            <div class="searchRight NoPaddingRight">
                                <label class="inputLabel">To</label>
                                <input id="t_trip_tolocation" name="t_trip_tolocation" class="XXinput searching"
                                    placeholder="Enter To" type="text" tabindex="2" required />
                            </div>
                        </div>
                        <div class="searchRow clearfix">
                            <div class="LB" style="margin-top: 0px;">
                                <label class="inputLabel">Vehicle Type</label>
                                <select style="height: 32px; margin-top: -1px;" required id="t_vechicle"
                                    class="XXinput searching" name="t_vechicle">
                            ...
                            <div class="searchRight retJouney">
                                ...
                                <input id="t_start_date" name="t_start_date" class="datepicker XXinput" required
                                    placeholder="yyyy-mm-dd" type="text" title="Date in the format yyyy-mm-dd"
                                    tabindex="3">
                            </div>
                        </div>
                        ...
                        <input type="hidden" id="t_customer_id" name="t_customer_id"
                            value="<?= (isset($this->session->userdata['session_data_fr']['c_id']) ? $this->session->userdata['session_data_fr']['c_id'] : ''); ?>">
                        ...
                        <input type="hidden" id="t_created_by" name="t_created_by"
                            value="<?= (isset($this->session->userdata['session_data_fr']['c_id']) ? $this->session->userdata['session_data_fr']['c_id'] : ''); ?>">
                        <input type="hidden" id="bookingemail" name="bookingemail"
                            value="<?= (isset($this->session->userdata['session_data_fr']['c_email']) ? $this->session->userdata['session_data_fr']['c_email'] : ''); ?>">
